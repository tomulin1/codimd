...
module.exports = function (sequelize, DataTypes) {
  var User = sequelize.define('User', {
    ...
    password: {
      type: Sequelize.TEXT,
      set: function (value) {
        var hash = scrypt.scryptSync(value, config.salt, dkLen, { N, r, p }).toString('hex')
  ...
  User.prototype.verifyPassword = function (attempt) {
    console.log(attempt, this.password, config.salt, scrypt.scryptSync(attempt, config.salt, dkLen, { N, r, p }).toString('hex'))
    if (scrypt.scryptSync(attempt, config.salt, dkLen, { N, r, p }).toString('hex') === this.password) {
      return this
    } else {
      return false
    }
